                            ...
                            <div class="col">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-nowrap">
                                        ...
                                        <tbody> @php $total = 0 @endphp @if(session('cart')) @foreach(session('cart') as
                                            $id => $details)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="text-heading font-semibold" href="#"> <img width="50px"
                                                            src="{{asset('storage/media/'.$details['image'])}}" /> </a>
                                                </td>
                                                <td> ₹{{ $details['price'] }} </td>
                                                <td>
                                                    <div
        ...
        <div class="fixed z-10 overflow-y-auto top-0 w-full left-0 hidden" id="modal1">
            <div class="flex items-center justify-center min-height-100vh pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div class="inline-block align-center bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
                    role="dialog" aria-modal="true" aria-labelledby="modal-headline">
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        @if(!empty($item)) @foreach($item as $list)
