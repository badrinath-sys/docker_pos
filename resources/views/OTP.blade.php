                                    ...
                                    <div class="tab-content pl-6 " id="main_form">
                                        <div class="tab-pane active " role="tabpanel" id="step1">
                                            ...
                                            <div class="col-md-11 mt-2 ml-3 mb-6">
                                                <button
                                                    class="  w-full next-step bg-blue-600 hover:bg-blue-700 text-white text-center hover:no-underline font-semi-bold py-2 px-3 rounded focus:outline-none focus:shadow-outline"
                                                    type="submit">
                                                    Next
                                                </button>
                                            </div>
